#' Create a use matrix
#' 
#' The function filters out from the raw data file the use matrix, which is
#' sometimes also called as input flow matrix.   The use matrix shows the 
#' technological relationships among industries. You can decide to make the 
#' households endogenous to the model by adding them with their labor inputs 
#' and their private consumption.  This is required when you want to calculated
#'  type II multipliers, for example. 
