...
check <- iotable_get( source = "germany_1995", geo = 'de', year = 1990,
             unit = "MIO_EUR", labelling  = 'iotables')
check <- iotable_get( source = "germany_1995", geo = 'DE', year = 1990,
                      unit = "MIO_EUR", labelling  = 'short')
check <- iotable_get2( source = "germany_1995", geo = 'DE', year = 1990,
                      unit = "MIO_EUR", labelling  = 'short')

check <- use_table_get( source = "germany_1995", geo = 'DE', year = 1990,
                      unit = "MIO_EUR", labelling  = 'iotables')
check <- use_table_get( source = "germany_1995", geo = 'DE', year = 1990,
...
check_primary <- primary_input_get ( input = "D11",
                                     ...
                                     unit = "MIO_EUR", 
                                     households = TRUE, labelling  = 'iotables')
check_output_de <- output_get( source = "germany_1995", geo = 'DE', year = 1990,
                        unit = "MIO_EUR", labelling  = 'iotables')
check_output_de <- output_get( source = "germany_1995", geo = 'DE', year = 1990,
...
check_2 <- use_table_get( source = "germany_1995", geo = 'DE', year = 1990,
