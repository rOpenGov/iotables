...
#'   \item{uk_row} The UK row identifier. All '.' and ' & ' converted to '-'
#'   \item{uk_row_label} The original UK row labels.
#'   \item{uk_col} The UK row identifier. All '.' and ' & ' converted to '-'
...
#'   \item{indue}{Eurostat label equivalents for columns}
#' }
