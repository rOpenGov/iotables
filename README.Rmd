...
You can download the manual in PDF for the  [0.4.7 development release](https://iotables.dataobservatory.eu/iotables_0.4.7.pdf). and follow the changes on the [Changelog/NEWS](https://iotables.dataobservatory.eu/news/index.html). 
