...
**Kindly cite this work** as follows: [Daniel Antal](https://github.com/antaldaniel). The R package iotables, version `r sessionInfo()$otherPkgs$iotables$Version`. URL: [https://ropengov.github.io/iotables/](https://ropengov.github.io/iotables/)
