...
You can install iotables 0.4.7 from CRAN or the latest 0.9.9 development version with github:
...
You can download the manual in PDF for the  [0.9.9 development release](https://iotables.dataobservatory.eu/iotables_0.499.pdf). and follow the changes on the [Changelog/NEWS](https://iotables.dataobservatory.eu/news/index.html). 
...
Daniel Antal. (2022, February 10). rOpenGov/iotables: Importing and Manipulating Symmetric Input-Output Tables (Version 0.9.9). Zenodo. [https://doi.org/10.5281/zenodo.5802515](https://zenodo.org/record/5153006/) for released version. 
