...
You can install iotables 0.4.7 from CRAN or the latest 0.9 development version with github:
...
Daniel Antal. (2022, February 10). rOpenGov/iotables: Importing and Manipulating Symmetric Input-Output Tables (Version 0.9). Zenodo. [https://doi.org/10.5281/zenodo.6033771](https://zenodo.org/record/5153006/) for released version. 
