...
Currently the following Eurostat SIOTs can be used: `naio_10_cp1700`, `naio_10_cp1750`, `naio_10_pyp1700`, `naio_10_pyp1750`. The tables follow a similar structure, but they are differing in two important aspects.  Unfortunately, Eurostat does not publish `naio_cp17_r2`, `naio_17_agg_60_r2`, `naio_17_agg_10_r2` anymore, but if you saved those files, it functions work with them, too, but they cannot be downloaded with `iotable_get` since they are not in the Eurostat database anymore.

Furthermore, you can download `naio_10_cp1620` (trade and transport margins) and `naio_10_cp1630` (net taxes) with the parameter `stk_flow="TOTAL"`. 
