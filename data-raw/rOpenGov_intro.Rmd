...
Then you can create the Leontief-inverse, which contains all the structural information about the relationships of 64x64 sectors of the chosen country (in this case, Slovakia) ready for the main equations of input-output economics:
...
The [Germany 1990](https://iotables.dataobservatory.eu/articles/germany_1995.html) provides an introduction of input-output economics and re-creates the examples of the [Eurostat Manual of Supply, Use and Input-Output Tables](https://iotables.dataobservatory.eu/articles/germany_1995.html), by Jörg Beutel (Eurostat Manual).
