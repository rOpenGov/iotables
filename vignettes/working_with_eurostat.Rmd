...
saveRDS(naio_10_cp1700, file.path('..', 'inst', 'extdata',
                                       'naio_10_cp1700.rds'))
...
message ( "Czech tax table")
cz_tax <-  iotable_get ( labelled_io_data = naio_10_cp1630, 
                         source = "naio_10_cp1630", geo = "SK", 
...
xlsx::write.xlsx ( I_cz, file = cz_file_name, sheetName = "I_cz",
                   col.names=TRUE, row.names=TRUE, append=FALSE)
xlsx::write.xlsx ( cz_tax, file = cz_file_name, sheetName = "cz_tax",
                   col.names=TRUE, row.names=TRUE, append=FALSE)
