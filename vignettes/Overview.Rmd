...
de_output <- iotables::output_get ( source = "germany_1990", geo = "DE",
...
```{r example_primary_output, echo = FALSE, warning = FALSE, message = FALSE}
#needs updatign with new vocubulary
#check_primary <- primary_input_get ( input = "wages_salaries",
...
de_use <- iotables::use_table_get ( source = "germany_1990", geo = "DE",
                       year = 1990, unit = "MIO_EUR", 
