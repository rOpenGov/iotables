...
You can create a matrix of input indicators, or direct effects on (final) demand with `direct_effects_create()`. The function by default creates input requirements for final demand.  With the code below it re-creates the Table 15.14 of the Eurostat manual. 
