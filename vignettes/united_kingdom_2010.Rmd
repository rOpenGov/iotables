...
The Leontief-inverse is described on pages 16-17 of the article. Again, comparing the first seven numerical columns with 8-digits precision we see that the re-calculated inverse and the published inverse is the same.
